# Autogenerated wrapper script for AcousticsToolbox_jll for armv6l-linux-musleabihf-libgfortran5
export bellhop, bellhop3d, bounce, field, field3d, kraken, krakenc, orca, scooter, sparc
...
JLLWrappers.@declare_executable_product(orca)
